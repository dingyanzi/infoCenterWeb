        ...
        <a-col flex="350px">
          <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
            ...
            <!-- <a-form-item label="部门" name="departmentId">
              <DepartmentTreeSelect class="form-item" ref="departmentTreeSelect" width="100%" :init="false"
                v-model:value="form.departmentId" disabled />
            </a-form-item> -->
          ...
          <a-form style="padding-left: 80px" layout="vertical">
            <a-form-item label="头像" name="avatar">
              ...
              <a-upload name="avatar" list-type="picture-card" class="avatar-uploader" :show-upload-list="false"
                :headers="{ Authorization: 'Bearer ' + useUserStore().getToken }" :customRequest="customRequest"
